...
module Hyku
  ...
  module ChromeThemes
    HOME = %w[practice_research heritage screening_room reference digital_collection].freeze
    SHOW = %w[practice_research_show heritage_show screening_room_show reference_show digital_collection_show].freeze
