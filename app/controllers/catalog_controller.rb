...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("dog_name", :stored_searchable), label: "Name of Dog"
    ...
    config.add_show_field solr_name("dog_name", :stored_searchable), label: "Name of Dog"
