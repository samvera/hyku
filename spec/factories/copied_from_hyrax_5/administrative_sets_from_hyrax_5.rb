...
FactoryBot.define do
  ...
  factory :hyrax_admin_set, class: 'AdminSetResource' do
    title { ['My Admin Set'] }
  ...
  factory :invalid_hyrax_admin_set, class: 'AdminSetResource' do
    # Title is required.  Without title, the admin set is invalid.
  end

  factory :default_hyrax_admin_set, class: 'AdminSetResource' do
