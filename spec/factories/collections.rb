...
FactoryBot.define do
  ...
  factory :collection_fedora do
    ...
    factory :public_collection_fedora, traits: [:public]

    trait :public do
      visibility { Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_PUBLIC }
    end

    factory :private_collection_fedora do
  ...
  factory :collection_lw_fedora, class: Collection do
    transient do
      user { create(:user) }
    ...
    factory :public_collection_lw_fedora, traits: [:public_lw]

    factory :private_collection_lw_fedora do
      visibility { Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_PRIVATE }
    end

    factory :institution_collection_lw_fedora do
      visibility { Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_AUTHENTICATED }
    end

    factory :named_collection_lw_fedora do
  ...
  factory :user_collection_lw_fedora, class: Collection do
    transient do
      user { create(:user) }
  ...
  factory :typeless_collection_lw_fedora, class: Collection do
