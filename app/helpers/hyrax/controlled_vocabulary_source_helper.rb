...
module Hyrax
  # Distinct from `Hyrax.config.controlled_vocabulary_label_service`: the deposit
  # form needs a field's options before any value exists, which is a different
  # question from resolving a stored id to its label.
