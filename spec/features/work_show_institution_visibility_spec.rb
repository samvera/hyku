...
RSpec.describe "Users trying to access an Institution Work's show page", type: :feature, clean: true, js: true, cohort: 'bravo' do # rubocop:disable Metrics/LineLength
