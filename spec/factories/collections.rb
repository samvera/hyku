...
FactoryBot.define do
  ...
  # ---
  # NOTE(bkiahstroud): Everything below this point in the file was brought over from Hyrax 2.5.1.
  # TODO(bkiahstroud): Work needs to be done to reconcile these two factories.
  # ---
