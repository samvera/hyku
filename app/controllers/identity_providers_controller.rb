  ...
  def create
    ...
    respond_to do |format|
      if @identity_provider.save
        format.html { redirect_to edit_identity_provider_url(@identity_provider), notice: "Auth provider was successfully created." }
  ...
  def update
    respond_to do |format|
      if @identity_provider.update(identity_provider_params)
        format.html { redirect_to edit_identity_provider_url(@identity_provider), notice: "Auth provider was successfully updated." }
